...
### Name & Positioning
**AttendX** — Roll call + marking presence, fast and frictionless. Implies both *speed* ("roll" as in quick) and *precision* ("mark" as in record).
...
- Top bar: Logo "AttendX", user menu (profile → settings → logout)
