...
export function ShareLinkSettings({
  ...
  return (
    <div className="mt-3 space-y-3 rounded-lg border border-teal/12 p-3.5">
      <div>
        ...
        {shareUrl && (
          <div className="mt-2 flex items-center gap-2 rounded-lg border border-teal/12 bg-cream px-3 py-2">
            <span className="min-w-0 flex-1 truncate font-mono text-xs text-teal">{shareUrl}</span>
            <button
              onClick={copyLink}
              className="flex shrink-0 items-center gap-1 text-xs text-turquoise hover:underline"
            >
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="text-xs text-text-secondary hover:text-teal hover:underline"
        >
          Close
        </button>
      </div>
