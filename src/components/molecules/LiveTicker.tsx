      ...
      <AnimatePresence initial={false}>
        {records.map((r) => (
          <motion.div
            ...
            className="group flex items-center justify-between gap-2 rounded-lg border border-teal/10 bg-cream px-3 py-2.5"
          >
            ...
            <div className="flex shrink-0 gap-1 opacity-100 transition-opacity md:opacity-0 md:group-hover:opacity-100">
              ...
              {onUnflag && r.flagged && (
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-md text-text-secondary hover:bg-turquoise/10 hover:text-turquoise"
                >
