      ...
      {session.requireGeofence && session.geofence ? (
        <div className="mb-6 flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 text-xs text-turquoise hover:underline disabled:opacity-50"
          >
        ...
        <div className="mb-6 space-y-3 rounded-lg border border-teal/12 p-3.5">
          {newGeofenceLocation ? (
