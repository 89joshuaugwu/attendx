    ...
    <div>
      ...
      {courses.length === 0 ? (
        <Card className="flex flex-col items-center py-10 text-center">
          ...
          <p className="font-medium text-teal">No courses yet</p>
        ...
        {loadingRoster ? (
          ...
          <div className="max-h-[50vh] space-y-1.5 overflow-y-auto">
            {roster.map((s) => (
              <div
                key={s.regNumber}
                className="flex items-center justify-between rounded-lg border border-teal/10 bg-cream px-3 py-2 text-sm"
              >
