  ...
  return (
    <PublicShell>
      <section className="mx-auto flex max-w-3xl flex-col items-center py-14 text-center md:py-24">
        <div className="mb-5 flex items-center gap-2 rounded-full border border-turquoise/30 bg-turquoise/10 px-3 py-1 text-xs font-medium text-turquoise">
      ...
      <section className="mx-auto grid w-full max-w-5xl gap-4 pb-16 md:grid-cols-3 md:gap-6 md:pb-24">
        {FEATURES.map(({ icon: Icon, title, body }) => (
          ...
          >
            <Icon className="mb-3 h-6 w-6 text-turquoise" />
      ...
      <footer className="w-full max-w-5xl border-t border-teal/10 py-6 text-center text-xs text-text-secondary">
