...
```
Using DESIGN.md and CONTEXT.md as reference, bootstrap a new Next.js 16 project named "attendx" with:
...
Requirements:
- QR encodes URL: https://attendx-ng.vercel.app/attend/{sessionId}?t={qrToken}
...
```
1. Push to GitHub (89joshuaugwu/attendx or similar)
